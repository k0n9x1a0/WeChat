...
func (Info *AndroidDeviceInfo) AndriodImei(DeviceId string) string {
	...
	Md5Data := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000000"))))
...
func (Info *AndroidDeviceInfo) AndriodID(DeviceId string) string {
	...
	Md5Data := lib.MD5ToLower(DeviceId + "SM1000001")
...
func (Info *AndroidDeviceInfo) AndriodPhoneSerial(DeviceId string) string {
	...
	Md5Data := lib.MD5ToLower(DeviceId + "SM1000002")
...
func (Info *AndroidDeviceInfo) AndriodWidevineDeviceID(DeviceId string) string {
	...
	Md5DataA := lib.MD5ToLower(DeviceId + "SM1000003")
	Md5DataB := lib.MD5ToLower(DeviceId + "SM1000004")
...
func (Info *AndroidDeviceInfo) AndriodWidevineProvisionID(DeviceId string) string {
	...
	Md5DataA := lib.MD5ToLower(DeviceId + "SM1000005")
...
func (Info *AndroidDeviceInfo) AndriodFSID(DeviceId string) string {
	...
	Md5DataA := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000012"))))
	Md5DataB := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000006"))))
	return "37063" + Md5DataA[0:2] + "|37063" + Md5DataA[2:4] + "@" + Md5DataA[4:19] + "|" + lib.MD5ToLower(DeviceId+"SM1000007") + "@" + Md5DataB[0:16] + lib.MD5ToLower(DeviceId+"SM1000008")
}
...
func (Info *AndroidDeviceInfo) AndriodBssid(DeviceId string) string {
	...
	Md5Data := lib.MD5ToLower(DeviceId + "SM1000009")
	A := Md5Data[5:7] + ":"
	B := Md5Data[7:9] + ":"
	C := Md5Data[9:11] + ":"
	D := Md5Data[11:13] + ":"
...
func (Info *AndroidDeviceInfo) AndriodSsid(DeviceId string) string {
	...
	Md5Data := lib.MD5ToLower(DeviceId + "SM10000026")
	A := Md5Data[5:7] + ":"
	B := Md5Data[7:9] + ":"
	C := Md5Data[9:11] + ":"
	D := Md5Data[11:13] + ":"
...
func (Info *AndroidDeviceInfo) AndriodPackageSign(DeviceId string) string {
	...
	Md5Data := lib.MD5ToLower(DeviceId + "SM1000010")
...
func (Info *AndroidDeviceInfo) AndroidRadioVersion(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000013"))))
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000014")+lib.MD5ToLower(DeviceId+"SM2000014")+lib.MD5ToLower(DeviceId+"SM3000014"), -1))
	L := fmt.Sprintf("%v", M[:1])
	K := fmt.Sprintf("%v", M[:2])
...
func (Info *AndroidDeviceInfo) AndroidManufacturer(DeviceId string) string {
	...
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000015")+lib.MD5ToLower(DeviceId+"SM2000015"), -1))
	L := fmt.Sprintf("%v", M[:3])
...
func (Info *AndroidDeviceInfo) AndroidBuildID(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000016"))))
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000017")+lib.MD5ToLower(DeviceId+"SM2000017"), -1))
...
func (Info *AndroidDeviceInfo) AndroidBuildBoard(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000021"))))
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000022")+lib.MD5ToLower(DeviceId+"SM2000022"), -1))
	G := fmt.Sprintf("%v", M[:3])
...
func (Info *AndroidDeviceInfo) AndroidPhoneModel(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000019"))))
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000020")+lib.MD5ToLower(DeviceId+"SM2000020"), -1))
...
func (Info *AndroidDeviceInfo) AndroidHardware(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000023"))))
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000024")+lib.MD5ToLower(DeviceId+"SM1000025"), -1))
	G := fmt.Sprintf("%v", M[:1])
...
func (Info *AndroidDeviceInfo) AndroidWifiName(DeviceId string) string {
	...
	reg := regexp.MustCompile("[a-zA-Z]+")
	M := lib.ALLGather(reg.FindAllString(lib.MD5ToLower(DeviceId+"SM1000027")+lib.MD5ToLower(DeviceId+"SM1000028"), -1))
...
func (Info *AndroidDeviceInfo) AndroidKernelReleaseNumber(DeviceId string) string {
	...
	S := strconv.Itoa(lib.BytesToInt([]byte(lib.MD5ToLower(DeviceId + "SM1000029"))))
	M := lib.MD5ToLower(DeviceId + "SM1000027")
...
func (Info *AndroidDeviceInfo) AndroidArch(DeviceId string) string {
	...
	M := lib.MD5ToLower(DeviceId + "SM1000030")
...
func (Info *AndroidDeviceInfo) AndriodSfMD5(DeviceId string) string {
	...
	return lib.MD5ToLower(DeviceId + "SM1000031")
}
...
func (Info *AndroidDeviceInfo) AndriodSfArmMD5(DeviceId string) string {
	...
	return lib.MD5ToLower(DeviceId + "SM1000032")
}
...
func (Info *AndroidDeviceInfo) AndriodSfArm64MD5(DeviceId string) string {
	...
	return lib.MD5ToLower(DeviceId + "SM1000033")
}
...
func SoftType_iPad(DeviceId string, osVersion string, RomModel string) string {
	uuid1, uuid2 := IOSUuid(DeviceId)
	return "<softtype><k3>" + osVersion + "</k3><k9>iPad</k9><k10>6</k10><k19>" + uuid1 + "</k19><k20>" + uuid2 + "</k20><k22>(null)</k22><k33>微信</k33><k47>1</k47><k50>1</k50><k51>com.tencent.xin</k51><k54>" + RomModel + "</k54><k61>2</k61></softtype>"
}

func SoftType_iPhone(DeviceId string) string {
	uuid1, uuid2 := IOSUuid(DeviceId)
	return "<softtype><k3>13.4.1</k3><k9>iPhone</k9><k10>2</k10><k19>" + uuid1 + "</k19><k20>" + uuid2 + "</k20><k22>中国移动</k22><k33>微信</k33><k47>1</k47><k50>1</k50><k51>com.tencent.xin</k51><k54>iPhone9,1</k54><k61>2</k61></softtype>"
}

func IOSUuid(DeviceId string) (uuid1 string, uuid2 string) {
	Md5DataA := lib.MD5ToLower(DeviceId + "SM202003220432")
	uuid1 = fmt.Sprintf("%x-%x-%x-%x-%x", Md5DataA[0:8], Md5DataA[2:6], Md5DataA[3:7], Md5DataA[1:5], Md5DataA[20:32])
	Md5DataB := lib.MD5ToLower(DeviceId + "BM202003220432")
...
func IOSMac(DeviceId string) string {
	Md5Data := lib.MD5ToLower(DeviceId + "CP202003220432")
...
func IOSGetCidUUid(DeviceId, Cid string) string {
	Md5Data := lib.MD5ToLower(DeviceId + Cid)
...
func IOSDeviceNumber(DeviceId string) int64 {
	ssss := []byte(lib.MD5ToLower(DeviceId))
	ccc := lib.Hex2int(&ssss) >> 8
